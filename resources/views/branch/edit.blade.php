                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="number" id="phone" name="phone" value="{{$branch->phone}}" class="form-control">
                                                        @error('phone')
                                                        <span class="text-danger">{{ $message }} </span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <h5>Correo Ventas:</h5>
                                                    <div class="controls">
                                                        <input type="email" name="email_cs" value="{{$branch->email_cs}}"   class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="email" name="email_s" value="{{$branch->email_s}}"   class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
