...
<div class="container-full">
    ...
    <div class="content-header">
        ...
        <a href="{{route('branch.index')}}" class="btn btn-danger btn-sm float-left"><i class="fa fa-plus" aria-hidden="true"></i> Ver Sucursales</a>
    </div>
    <!-- Main content -->
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <h5>Correo Ventas:</h5>
                                                    <div class="controls">
                                                        <input type="email" name="email_cs" value="{{old('email_cs'),''}}" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <h5>Correo Atención:</h5>
                                                    <div class="controls">
                                                        <input type="email" name="email_s" value="{{old('email_s'),''}}"  class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
