                                        ...
                                        <div class="row">
                                            ...
                                            @foreach($permissions as $permission)
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="{{$permission->id}}" name='selected[]' value="{{$permission->id}}" @foreach($selected as $check) {{($permission->id == $check->id ? 'checked' : '')}} @endforeach>
