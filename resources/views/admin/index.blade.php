            ...
            <div class="col-xl-2 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Clientes</p>
            ...
            <div class="col-xl-2 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Ventas</p>
                            <h3 class="text-white mb-0 font-weight-500">3400 <small class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small></h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-2 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Ventas Perdidas</p>
            ...
            <div class="col-xl-2 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Pedidos Entrantes</p>
            ...
            <div class="col-xl-2 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Pedidos Salientes</p>
            ...
            <div class="col-xl-2 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Total de Ingresos</p>
                ...
                <div class="box bg-info bg-img" style="background-image: url(../images/gallery/bg-1.png)">
                    <div class="box-body text-center">							
                        ...
                        <div class="max-w-500 mx-auto">
                            <h2 class="text-white mb-20 font-weight-500">Empleado de mes,</h2>
